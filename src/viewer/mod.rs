...
/// Which label tells a set of recordings apart. Shared with the WASM viewer so
/// an archive is named the same wherever it is opened.
pub(crate) use ::dashboard::capture_alias::discriminating_alias_key;
